  ...
  return (
    <div className="py-8 md:py-0 flex flex-col px-5">
      ...
      <p className="sm:text-[16px] 2xl:text-[24px] text-[14px] 2xl:leading-[36px] sm:leading-[24px] leading-[20px] font-dmSans text-secondary font-normal mb-5 text-center">
        ...
        Recommendation, Post, Bio, Summary, Hashtag.
      </p>
      <div className="mx-auto w-[230px] 2xl:w-[295px]">
        <Link href="/linkedin-recommendation-generator#generate_linkedIn_recommendation">
          <PrimaryButton>
...
export default LinkedInRecommendationDescription;
