...
export const BaseForm = ({
  ...
  <section
    className={`flex flex-col gap-3 rounded-md bg-[#F6F5FF] p-6 pt-4 shadow transition-opacity duration-200 ${className}`}
  >
    {heading && <h1 className="font-dmSans font-bold">{heading}</h1>}
    {children}
  </section>
);
